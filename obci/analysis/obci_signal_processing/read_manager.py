...
from obci.analysis.obci_signal_processing.signal import data_raw_write_proxy
from obci.analysis.obci_signal_processing.signal import info_file_proxy
from obci.analysis.obci_signal_processing.tags import tags_file_writer
...
class ReadManager(object):
    ...
    def __init__(self, p_info_source, p_data_source, p_tags_source):
        ...
        self.__p_info_source = p_info_source
        self.__p_data_source = p_data_source
        self.__p_tags_source = p_tags_source
