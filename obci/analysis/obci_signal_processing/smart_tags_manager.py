...
from obci.analysis.obci_signal_processing.tags import smart_tag
import queue
import obci.analysis.obci_signal_processing.read_manager as read_manager

from obci.analysis.obci_signal_processing.signal import signal_exceptions
import obci.analysis.obci_signal_processing.obci_signal_processing_logging as logger
import obci.analysis.obci_signal_processing.types_utils as types_utils
import queue
import functools
...
class SmartTagsManager(object):
    ...
    def _init_smart_tags(self, p_tag_def):
        ...
        self._smart_tags.sort(key=functools.cmp_to_key(cmp_tags))
