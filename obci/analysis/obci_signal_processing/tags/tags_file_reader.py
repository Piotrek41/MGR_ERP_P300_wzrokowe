...
import obci.analysis.obci_signal_processing.tags.tag_utils as tag_utils
import obci.analysis.obci_signal_processing.tags.tags_logging as logger
import functools
...
class TagsFileReader(object):
    ...
    def _parse_tags_file(self, p_tags_file):
        ...
        self._tags.sort(key=functools.cmp_to_key(cmp_tags))
